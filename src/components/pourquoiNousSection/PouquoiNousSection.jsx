            ...
            <div className="flex p-4">
              ...
              <div className="text-xl basis-3/4 space-y-4 *:tracking-wide px-6">
                ...
                <p>
                  ...
                  créativité pour façonner des expériences uniques qui
                  inspirent, captivent et engagent.
                </p>{" "}
                <p>
                  Que vous soyez une start-up ambitieuse ou une grande
                  entreprise établie, nous sommes là pour vous accompagner à
                  chaque étape de votre parcours vers le succès. Découvrez
                  comment nous pouvons donner vie à votre vision et vous aider à
